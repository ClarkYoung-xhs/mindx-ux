...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'landing.feat1Desc': 'Collaborate with agents to draft, edit, and refine docs that stay useful beyond a single session.',
    'landing.feat2Title': 'Save context in one place',
    'landing.feat2Desc': 'Keep docs, files, chats, and project context in one shared workspace for you and your agents.',
    'landing.feat3Title': 'Find past work and continue',
    'landing.feat3Desc': 'Search past work, recover context, and pick up where you left off.',
  ...
  zh: {
    ...
    'landing.feat1Desc': '与 Agent 协作起草、编辑和完善文档，让高价值内容在多次会话间持续留存。',
    'landing.feat2Title': '将上下文保存在一处',
    'landing.feat2Desc': '在同一个共享空间中，为你和你的 Agent 集中保存文档、文件、对话与项目上下文。',
    'landing.feat3Title': '随时找回并继续过去的工作',
    'landing.feat3Desc': '搜索过往工作，恢复上下文，并从你上次离开的地方无缝接续。',

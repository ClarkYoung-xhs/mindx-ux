...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'landing.feat1Desc': 'Collaborate with AI agents to draft, edit, and refine your documents in real-time.',
    'landing.feat2Title': 'Save everything in one place',
    'landing.feat2Desc': 'Centralize your markdown, whiteboards, spreadsheets, and files in a unified space.',
    'landing.feat3Title': 'Find past work and continue',
    'landing.feat3Desc': 'Easily search through your history to revive past context and pick up where you left off.',
  ...
  zh: {
    ...
    'landing.feat1Desc': '与 AI Agent 实时协作，共同起草、编辑和完善文档。',
    'landing.feat2Title': '一切保存在同一处',
    'landing.feat2Desc': '集中管理你所有的 Markdown、表格和白板文件。',
    'landing.feat3Title': '随时找回并继续过去的工作',
    'landing.feat3Desc': '轻松搜索并恢复之前的任务，完整保留上下文。',

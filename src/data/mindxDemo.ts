...
export const memorySourceLinks: SourceLink[] = [
  {
    ...
    storage: 'memory',
    dataSourceId: 'ds1',
    summary: '手动上传的访谈摘录里，最关键的信号是“用户相信可追溯，而不是更大记忆”。',
  ...
  },
  {
    ...
    storage: 'memory',
    dataSourceId: 'ds2',
    summary: '会议转写把“Knowledge 不升一级”和“Workspace 继续对外承接”的判断记录得更完整。',
  ...
  },
  {
    ...
    quote: 'Durable memory earns trust when people can trace where it came from.',
  ...
  },
  {
    ...
    storage: 'memory',
    dataSourceId: 'ds4',
    summary: '周报把“2.0 是升级不是新产品”和“三段结构先固定”这两个判断重新写稳了。',
    quote: '现在先把 Base Memory / Timeline / Knowledge 固定下来，别再开第四层。',
...
export const memoryTimeline: MemoryEvent[] = [
  {
    ...
    summary: 'The imported transcript pushed the “Knowledge stays inside Memory” decision back into active refinement.',
    docId: 'ds2',
    docName: '飞书妙记：03/24 产品同步',
  ...
  },
  {
    ...
    summary: 'A manually uploaded interview excerpt added stronger evidence that trust comes from visible provenance.',
    docId: 'ds1',
    docName: '用户信任研究原始访谈摘录',
  ...
  },
  {
    ...
    summary: 'The synced weekly report made the “2.0 is an upgrade” positioning stable enough to mount.',
    docId: 'ds4',
    docName: '腾讯文档同步：产品周报',
  ...
  },
  {
    ...
    summary: 'An external case study sharpened the argument that durable memory has to stay auditable.',
    docId: 'ds3',
    docName: '网页剪存：Memory 产品案例',
    actorName: 'Research Bot',
    actorType: 'agent',

...
import type { DocType } from "../types/block";
...
export const memorySourceLinks: SourceLink[] = [
  {
    id: "msrc1",
    docId: "ds1",
    docName: "用户信任研究原始访谈摘录",
    kind: "document",
    storage: "memory",
    dataSourceId: "ds1",
    summary:
      "手动上传的访谈摘录里，最关键的信号是“用户相信可追溯，而不是更大记忆”。",
    quote: "用户需要看到这条记忆从哪里来，为什么现在还成立。",
    timestamp: "2026-03-24T09:46:00Z",
    participants: ["Me", "Research Bot"],
  },
  {
    id: "msrc2",
    docId: "ds2",
    docName: "飞书妙记：03/24 产品同步",
    kind: "chat",
    storage: "memory",
    dataSourceId: "ds2",
    summary:
      "会议转写把“Knowledge 不升一级”和“Workspace 继续对外承接”的判断记录得更完整。",
    quote: "Knowledge 继续放在 Memory 里面，不单独出去做一层。",
  ...
  },
  {
    id: "msrc3",
    docId: "ds3",
    docName: "网页剪存：Memory 产品案例",
    kind: "document",
    storage: "memory",
    dataSourceId: "ds3",
    summary: "外部案例强调长期记忆必须保留证据链、修订链和审阅路径。",
    quote:
      "Durable memory earns trust when people can trace where it came from.",
    timestamp: "2026-03-23T16:12:00Z",
    participants: ["Me", "Research Bot"],
  },
  {
    id: "msrc4",
    ...
    dataSourceId: "ds4",
    summary:
      "周报把“2.0 是升级不是新产品”和“三段结构先固定”这两个判断重新写稳了。",
    quote:
      "现在先把 Base Memory / Timeline / Knowledge 固定下来，别再开第四层。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "产品同步会上明确收敛：Knowledge 暂不升级为一级模块，继续作为 Memory 内部的结构化资产层。",
    quote:
      "如果现在把 Knowledge 拉成一级导航，用户会把它理解成第二套产品，而不是 Memory 的升级。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "研究笔记反复验证同一个结论：用户相信的不是“更大记忆”，而是可追溯、可复核的来源链路。",
    quote:
      "用户不是因为你记得多就信你，而是因为他能看见这张卡从哪里来、为什么还成立。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "IA PRD 已把 Memory 固定为 Base Memory、Timeline、Knowledge 三段结构，并明确 Knowledge 是 Memory 内部的资产层。",
    quote:
      "Knowledge 不是平行模块，它是把 Memory 里的反复判断沉淀成可复用资产的地方。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "叙事评审里已经收敛：产品表达先给判断，再补机制说明，避免堆 AI 功能词。",
    quote:
      "先把判断说出来，再解释为什么。产品口吻要像一个会做取舍的 PM，不像在念宣传册。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "工作板上主要沉淀的是两类未决问题：L2/L3/L4 的晋升规则，以及待跟进事项到底该留在哪一层。",
  ...
  },
  {
    ...
    storage: "workspace",
    summary:
      "日报把今天的工作主线收束成一件事：不是继续加卡片，而是先把层级、归属和治理规则讲清楚。",
...
export const memoryAssets: MemoryAsset[] = [
  {
    ...
    summary:
      "mindX 2.0 当前版本的信息架构已经收敛：Knowledge 作为 Memory 内部的结构化资产层存在，不单独承担一级入口。",
    confidence: "High",
    freshness: "42 分钟前定稿",
    sourceIds: ["src1", "src3", "src6", "msrc2"],
  ...
  },
  {
    ...
    summary:
      "当前版本的产品入口策略是：Workspace 继续承接日常工作流，Memory 在内部逐步显性化用户理解与长期资产，避免用户误解为第二套系统。",
    confidence: "Medium",
    freshness: "1 小时前复核",
    sourceIds: ["src1", "src6", "msrc2"],
  ...
  },
  {
    ...
    summary:
      "当前稳定的表达习惯是先把结论和取舍讲清楚，再解释页面机制、实现方式或系统细节，不用功能清单当开头。",
    confidence: "High",
    freshness: "1 小时前整理",
    sourceIds: ["src4", "src6"],
  ...
  },
  {
    ...
    summary:
      "品牌和产品表达都应避免空泛的大词、AI 套话和汇报腔，保持像资深产品经理在做判断时的直接表达。",
    confidence: "High",
    freshness: "昨天补充",
    sourceIds: ["src4"],
    ...
    docIds: ["d5"],
    evidence: ["品牌语气评审里已经明确否掉了“宏大叙事”和“仪表盘口吻”的写法。"],
    nextStep:
      "这条偏好适合挂到 UI 文案、营销文案和 Founder narrative 的所有写作 agent 上。",
  },
  {
    id: "mem5",
    type: "insight",
    ...
    summary:
      "长期记忆要成立，核心不是把卡片做得更多，而是让用户看见来源、审核过程和当前为什么仍然有效。",
    confidence: "High",
    freshness: "55 分钟前稳定",
    sourceIds: ["src2", "src6", "msrc1", "msrc3"],
    ...
    nextStep:
      "后续所有卡片设计、来源展示和 review 机制，都应围绕这条原则展开。",
  },
  {
    id: "mem6",
    type: "constraint",
    ...
    summary:
      "这套系统只有从真实文档、协作过程和决策流里长出来，才会被持续使用；如果变成独立档案库，复用价值会快速下降。",
    confidence: "High",
    freshness: "48 分钟前锁定",
    sourceIds: ["src1", "src2", "src3", "msrc3"],
  ...
  },
  {
    ...
    summary:
      "当前所有产品表达都要建立在“连续升级”而不是“重新发明”上，避免用户把 2.0 理解成割裂的新系统。",
    confidence: "High",
    freshness: "今天锁定",
    sourceIds: ["src1", "src6", "msrc4"],
  ...
  },
  {
    ...
    summary:
      "这三段结构已经足够承接 mindX 2.0 当前阶段的记忆能力，后续功能应该优先往里塞，而不是继续扩一级信息架构。",
    confidence: "High",
    freshness: "36 分钟前写入宪法层",
    sourceIds: ["src3", "src6", "msrc4"],
  ...
  },
  {
    ...
    summary:
      "现在已经把层级名字讲清楚了，但“什么条件下从项目判断升到长期原则、再升到核心锚点”还缺一套明确规则。",
    confidence: "Medium",
    freshness: "24 分钟前进入复核",
    sourceIds: ["src2", "src5", "src6", "msrc1", "msrc4"],
    ...
    nextStep:
      "下一步需要把来源、重复出现、作用范围、可逆性这四个判断条件写成 checklist。",
  },
  {
    id: "mem10",
    type: "follow-up",
    ...
    summary:
      "现在的 follow-up 看起来像资产，实际又更像流程中的开放问题。这个边界如果不收敛，Knowledge 页会继续变脏。",
    confidence: "Medium",
    freshness: "今天捕获",
    sourceIds: ["src5", "src6", "msrc4"],
    ...
    nextStep:
      "建议先试一版：Timeline 承接开放问题，Knowledge 只保留候选资产和已沉淀资产。",
  },
];
...
export const memoryTimeline: MemoryEvent[] = [
  {
    ...
    dayLabel: "Today",
    timeLabel: "14:18",
    occurredAt: "2026-03-24T14:18:00Z",
    stage: "candidate",
    lane: "refine",
    title: "Product sync transcript reopened the navigation judgment",
    summary:
      "The imported transcript pushed the “Knowledge stays inside Memory” decision back into active refinement.",
    docId: "ds2",
    docName: "飞书妙记：03/24 产品同步",
    actorName: "memo agent",
    actorType: "agent",
    sourceIds: ["msrc2", "src1"],
    assetIds: ["mem1"],
    tags: ["knowledge", "memory", "sync"],
  },
  {
    id: "evt9",
    dayLabel: "Today",
    timeLabel: "12:24",
    occurredAt: "2026-03-24T12:24:00Z",
    stage: "candidate",
    lane: "extract",
    title: "Interview upload reinforced the provenance principle",
    summary:
      "A manually uploaded interview excerpt added stronger evidence that trust comes from visible provenance.",
    docId: "ds1",
    docName: "用户信任研究原始访谈摘录",
    actorName: "Research Bot",
    actorType: "agent",
    sourceIds: ["msrc1", "src2"],
    assetIds: ["mem5"],
  ...
  },
  {
    ...
    dayLabel: "Today",
    timeLabel: "08:42",
    occurredAt: "2026-03-24T08:42:00Z",
    stage: "durable",
    lane: "mount",
    title: "Weekly report hardened the upgrade-not-reinvention anchor",
    summary:
      "The synced weekly report made the “2.0 is an upgrade” positioning stable enough to mount.",
    docId: "ds4",
    docName: "腾讯文档同步：产品周报",
    actorName: "Claude Assistant",
    actorType: "agent",
    sourceIds: ["msrc4", "src6"],
    assetIds: ["mem7", "mem8"],
  ...
  },
  {
    ...
    dayLabel: "Yesterday",
    timeLabel: "16:12",
    occurredAt: "2026-03-23T16:12:00Z",
    stage: "candidate",
    lane: "extract",
    title: "Web clip introduced a stronger provenance reference",
    summary:
      "An external case study sharpened the argument that durable memory has to stay auditable.",
    docId: "ds3",
    docName: "网页剪存：Memory 产品案例",
    actorName: "Research Bot",
    actorType: "agent",
  ...
  },
  {
    ...
    summary:
      "The next-action-first rule is now written as a reusable product constraint.",
    docId: "d1",
  ...
  },
  {
    ...
    summary:
      "User quotes and the daily report were merged into a candidate insight about visible progress.",
    docId: "d4",
  ...
  },
  {
    ...
    summary:
      "The team aligned that onboarding should lead with a visible first win instead of a feature tour.",
    docId: "d6",
  ...
  },
  {
    ...
    summary:
      "The memory layer closed the loop from morning standup to launch prep so the day can be reused later.",
    docId: "d13",
  ...
  },
  {
    ...
    summary:
      "A stable voice preference was mounted so future writing feels like a teammate, not a dashboard.",
    docId: "d5",
  ...
  },
  {
    ...
    summary:
      "The dashboard review exposed that activation without support load is an incomplete success metric.",
    docId: "d2",
...
export const agentConnections: AgentConnection[] = [
  {
    ...
    description:
      "Operates inside Workspace, closes loops on the PM day, and mounts stable product decisions before new drafting starts.",
    mountedAssetCount: 8,
    ...
    latestAction:
      "Mounted the onboarding rule into product-writing context 18 minutes ago",
  ...
  },
  {
    ...
    description:
      "Expands raw interview notes into evidence-backed insight candidates before they harden into memory.",
    mountedAssetCount: 5,
    readScopes: ["Insight assets", "Open questions", "Related workspace docs"],
    writeScopes: ["Research candidates", "Evidence packets"],
    latestAction:
      "Wrote back a visible-progress insight candidate from interview notes 46 minutes ago",
  ...
  },
  {
    ...
    description:
      "Reads follow-ups from Memory so launch tables stay attached to actual product questions.",
    mountedAssetCount: 3,
    readScopes: ["Finance follow-ups", "Constraints", "Decision assets"],
    writeScopes: ["Scenario notes", "Cost deltas"],
    latestAction:
      "Waiting on a request to pair activation with support load in the launch dashboard",
...
export const mountedMemoryPacks: MountedMemoryPack[] = [
  {
    ...
    description:
      "Mounted context bundle built from first-win onboarding, visible progress, and PRD guardrail assets.",
  ...
  },
  {
    ...
    description:
      "Turns teammate-like product voice into a default preference for writing agents.",
    assetIds: ["mem4"],
  ...
  },
  {
    ...
    description:
      "Mounts launch metric follow-ups so analysis agents keep activation tied to support load.",
    assetIds: ["mem5"],
...
export const agentWritebacks: AgentWriteback[] = [
  {
    ...
    detail:
      "Derived from the latest interview debrief and now waiting in the Memory review layer.",
    assetId: "mem2",
    docId: "d4",
    docName: "User Interview Debrief",
  },
  {
    ...
    detail:
      "Subsequent product-writing work now inherits this tone by default.",
    assetId: "mem4",
    docId: "d5",
    docName: "Home Feed Copy Review",
  },
...
export function buildDocumentMemoryMeta(
  assets: MemoryAsset[],
): Record<string, DocumentMemoryMeta> {
  ...
  return Object.entries(byDocId).reduce<Record<string, DocumentMemoryMeta>>(
    (accumulator, [docId, relatedAssets]) => {
      const candidateCount = relatedAssets.filter(
        (asset) => asset.status === "candidate",
      ).length;
      const reviewCount = relatedAssets.filter(
        (asset) => asset.status === "review",
      ).length;
      const durableCount = relatedAssets.filter(
      ...
      if (candidateCount > 0)
        latest = `${candidateCount} candidate ${candidateCount > 1 ? "signals" : "signal"}`;
      else if (reviewCount > 0)
        latest = `${reviewCount} insight ${reviewCount > 1 ? "cards in review" : "card in review"}`;
      else if (durableCount > 0)
        latest = `${durableCount} durable ${durableCount > 1 ? "assets" : "asset"}`;

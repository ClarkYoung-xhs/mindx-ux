...
import { SmartCanvasIcon } from "../components/DocIcons";
...
export default function SharedDocumentView() {
  ...
  const documentTitle =
    lang === "zh" ? "Project Alpha 系统架构文档" : "Project Alpha Architecture";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-[11px] text-stone-400">
              <span>
                {lang === "zh" ? "分享者" : "Shared by"} {ownerName}
              </span>
              <span>·</span>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-stone-500">
                  <span className="flex items-center gap-1">
                    ...
                    {lang === "zh" ? "位协作者" : "collaborators"}
                  </span>
                  <span>·</span>
                  <span className="flex items-center gap-1">
                    <FileText className="w-3 h-3" /> Smart Canvas
                  </span>
                  <span>·</span>
                  <span className="flex items-center gap-1">
                    <Clock className="w-3 h-3" />{" "}
                    {lang === "zh" ? "创建于 3 天前" : "Created 3 days ago"}
                  </span>
                </div>
                <div className="flex flex-wrap gap-2 mt-3">
                  {["Project Alpha", "PRD"].map((label) => (
                    <span
                      key={label}
                      className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded-md text-[11px] font-medium"
                    >
                      {label}
                    </span>
                  ))}
                ...
                {[
                  {
                    ...
                    desc:
                      lang === "zh"
                        ? "多个 Agent 同时参与文档创作和知识管理"
                        : "Multiple agents co-creating docs in real-time",
                  },
                  {
                    icon: "📄",
                    title:
                      lang === "zh" ? "智能文档引擎" : "Smart Document Engine",
                    desc:
                      lang === "zh"
                        ? "自动生成报告、分析数据、汇总信息"
                        : "Auto-generate reports, analyze data, summarize info",
                  },
                  {
                    icon: "🔒",
                    title: lang === "zh" ? "安全可控" : "Secure & Controlled",
                    desc:
                      lang === "zh"
                        ? "精细的权限管理，企业级安全保障"
                        : "Fine-grained permissions, enterprise-grade security",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
